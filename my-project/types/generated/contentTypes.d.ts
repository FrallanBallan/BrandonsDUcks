...
export interface ApiBookBook extends Schema.CollectionType {
  ...
  attributes: {
    ...
    bookmark: Attribute.Boolean & Attribute.DefaultTo<false>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiSeasonalSeasonal extends Schema.SingleType {
  collectionName: 'seasonals';
  info: {
    singularName: 'seasonal';
    pluralName: 'seasonals';
  ...
  attributes: {
    pickColor: Attribute.String;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::seasonal.seasonal',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::seasonal.seasonal': ApiSeasonalSeasonal;
